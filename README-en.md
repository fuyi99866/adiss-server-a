...
# Project Guidelines
[Online Documentation](https://www.adiss-server-a.com/) : https://www.adiss-server-a.com/



[Development Steps](https://www.adiss-server-a.com/docs/help) (Contributor:  <a href="https://github.com/LLemonGreen">LLemonGreen</a> And <a href="https://github.com/fkk0509">Fann</a>)
...
[Online Demo](http://demo.adiss-server-a.com/)

username：admin

password：123456

> adiss-server-a is a full-stack (frontend and backend separation) framework designed for management system. 
...
Hi! Thank you for choosing adiss-server-a.

adiss-server-a is a full-stack (frontend and backend separation) framework for developers, designers and product managers.

We are excited that you are interested in contributing to adiss-server-a. Before submitting your contribution though, please make sure to take a moment and read through the following guidelines.
...
- [adiss-server-a_v2_dev](https://github.com/flipped-aurora/adiss-server-a/tree/adiss-server-a_v2_dev) (v2.0 [GormV1](https://v1.gorm.io) Stable branch)
- [gva_gormv2_dev](https://github.com/flipped-aurora/adiss-server-a/tree/gva_gormv2_dev) (v2.0 [GormV2](https://v2.gorm.io) Development branch)
...
- Use git to clone this project
    - ```git
        git clone https://github.com/flipped-aurora/adiss-server-a.git
      ```
...
- docker-compose uses a custom docker network
    ...
    - The default network name is adiss-server-a_network, and the default is bridge mode
...
- [init.sql](.docker-compose/docker-entrypoint-initdb.d/init.sql) is for docker-compose ==experience this project==, prohibit the use of [init.sql](.docker-compose/docker-entrypoint-initdb.d/init.sql) to initialize project data, Database initialization[Please use this method](https://www.adiss-server-a.com/docs/help#step1%EF%BC%9A%E6%95%B0%E6%8D%AE%E5%BA%93%E5%88%9D%E5%A7%8B%E5%8C%96)
...
```bash
# clone the project
git clone https://github.com/piexlmax/adiss-server-a.git
...
![Architecture diagram](http://qmplusimg.henrongyi.top/gva/adiss-server-a.png)
...
#### Wechat group: comment "加入adiss-server-a交流群"

| Wechat |
|  :---:  | 
| <img width="150" src="http://qmplusimg.henrongyi.top/qrjjz.png"> 

#### [About Us](https://www.adiss-server-a.com/about/)

## 9. Donate

If you find this project useful, you can buy author a glass of juice :tropical_drink: [here](https://www.adiss-server-a.com/docs/coffee)
