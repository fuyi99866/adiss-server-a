...
[gitee地址:https://gitee.com/pixelmax/adiss-server-a](https://gitee.com/pixelmax/adiss-server-a)

[github地址:https://github.com/flipped-aurora/adiss-server-a](https://github.com/flipped-aurora/adiss-server-a)

[vue3版本分支地址:https://github.com/flipped-aurora/adiss-server-a/tree/vue3Develop](https://github.com/flipped-aurora/adiss-server-a/tree/vue3Develop)

# 项目文档
[在线文档](https://www.adiss-server-a.com/) : https://www.adiss-server-a.com/

[从环境到部署教学视频](https://www.bilibili.com/video/BV1fV411y7dT)

[开发教学](https://www.adiss-server-a.com/docs/help) (贡献者:  <a href="https://github.com/LLemonGreen">LLemonGreen</a> And <a href="https://github.com/fkk0509">Fann</a>)
...
[在线预览](http://demo.adiss-server-a.com/)

测试用户名：admin

测试密码：123456

> adiss-server-a是一个基于vue和gin开发的全栈前后端分离的后台管理系统，集成jwt鉴权，动态路由，动态菜单，casbin鉴权，表单生成器，代码生成器等功能，提供多种示例文件，让您把更多时间专注在业务开发上。

### 1.2 贡献指南
Hi! 首先感谢你使用 adiss-server-a。

adiss-server-a 是一套为后台管理平台准备的一整套前后端分离架构式的开源框架，旨在快速搭建后台管理系统。

adiss-server-a 的成长离不开大家的支持，如果你愿意为 adiss-server-a 贡献代码或提供建议，请阅读以下内容。
...
- master: 2.0, 用于生产环境
- develop: 2.0, 用于测试环境
- [adiss-server-a_v2_dev](https://github.com/flipped-aurora/adiss-server-a/tree/adiss-server-a_v2_dev) (v2.0 [GormV1版本](https://v1.gorm.io)稳定分支)
- [gva_gormv2_dev](https://github.com/flipped-aurora/adiss-server-a/tree/gva_gormv2_dev) (v2.0 [GormV2版本](https://v2.gorm.io)开发分支)
...
- golang版本 >= v1.14
- IDE推荐：Goland
- 初始化项目： 不同版本数据库初始化不通 参见https://www.adiss-server-a.com/docs/server#1-%E5%88%9D%E5%A7%8B%E5%8C%96server%E9%A1%B9%E7%9B%AE
...
- docker-compose使用自定义的一个docker网络
	...
	- 默认的network名为adiss-server-a_network,默认是bridge模式
...
使用 goland等编辑工具，打开server目录，不可以打开 adiss-server-a跟目录
...
![系统架构图](http://qmplusimg.henrongyi.top/gva/adiss-server-a.png)
...
添加微信，备注"加入adiss-server-a交流群"

### [关于我们](https://www.adiss-server-a.com/about/)

## 9. 捐赠

如果你觉得这个项目对你有帮助，你可以请作者喝饮料 :tropical_drink: [点我](https://www.adiss-server-a.com/docs/coffee)
