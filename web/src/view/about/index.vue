<template>
  <div>
    <el-row :gutter="10">
      <el-col :span="12">
        <el-card>
          <div slot="header">adiss-server-a</div>
          <div>
            <el-row>
              <el-col :span="8" :offset="8">
                <a href="https://github.com/flipped-aurora/adiss-server-a">
                  <img
            ...
            <el-row :gutter="10">
              <el-col :span="8">
                <a href="https://github.com/flipped-aurora/adiss-server-a">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/watchers/flipped-aurora/adiss-server-a.svg?label=Watch"
                    alt=""
                  />
                </a>
              </el-col>
              <el-col :span="8">
                <a href="https://github.com/flipped-aurora/adiss-server-a">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/stars/flipped-aurora/adiss-server-a.svg?style=social"
                    alt=""/></a
              ></el-col>
              <el-col :span="8">
                <a href="https://github.com/flipped-aurora/adiss-server-a">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/forks/flipped-aurora/adiss-server-a.svg?label=Fork"
                    alt=""/></a
              ></el-col>
            </el-row>
          </div>
